...
const About = () => {
  ...
  return (
    ...
    >
      <h1 className="border-b-[1px]  border-gray-400 font-viga  pb-4 font-medium mb-4 mt-2">
        About
      </h1>
      <p className="text-sm font-thin mt-3 border-b-[1px] font-viga border-gray-400 pb-4 opacity-75">
        I have been in the world of programming for 3 years with mastery of the
        latest technology on the front end and back end.
      </p>
      <ul className="opacity-75">
        ...
        <li className="flex font-viga items-center mt-4">
          <IoBriefcaseOutline />
          <p className="ml-2">Sofware Engginer</p>
        </li>
      </ul>
    </div>
  );
